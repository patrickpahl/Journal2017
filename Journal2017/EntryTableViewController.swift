...
class EntryTableViewController: UITableViewController, UISearchBarDelegate, UITextFieldDelegate {
    ...
    // Changes search results if user is typing. Changes var searchActive to true when user is typing.
